...
export class DeviceService {
  ...
  async sendUSBCommand(type: USBCommandType, payload: DeviceOutgoingData | null = null): Promise<DeviceIncomingData | void> {
  ...
  getSerialNumber(): string {
    return this.serialNumberSignal();
  }

  getAppStatus(): Nullable<DeviceAppState> {
    return this.deviceAppStatusSignal();
  }
