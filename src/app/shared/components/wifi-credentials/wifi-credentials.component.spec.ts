...
describe('WiFiCredentialsComponent', () => {
  ...
  it('should call sendUSBCommand and set isSendingCredentials on submit (success)', fakeAsync(() => {
    ...
    component.onSubmit();
    expect(component.isSendingCredentials()).toBe(true); // Should be set immediately
  ...
  it('should show snackbar and reset isSendingCredentials on submit error', async () => {
    ...
    await component.onSubmit(); // Wait for the async operation to complete
    
    // Check that the error service was called correctly
  ...
  it('should call sendUSBCommand and reset isRefreshingWiFiNetworks on refresh', async () => {
    ...
    await component.refreshWiFiNetworks(); // Wait for the async operation to complete
