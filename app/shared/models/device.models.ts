export type DeviceOutgoingData = WiFiCredentials | ProvisioningData | USBCommand; // KEEP
...
export type DeviceIncomingData =
  ...
  | { cid?: string, type: DeviceMessageType; sn: string, data?: undefined }; // KEEP
...
export enum DeviceAppState { // KEEP
    STARTED,
...
export enum DeviceMessageType { // KEEP
    APP_STATE,
    WIFI_NETWORKS_LIST,
    ERROR,
    ACKNOWLEDGMENT
